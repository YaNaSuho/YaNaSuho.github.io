...
return cocktails_array[i];
   ...
   checkboxes = document.getElementsByClassName('larger');
        ...
        var filter_word = "";
        filters = [["Крепкий", "Слабоалкогольный", "Безалкогольный"], ["Лонг дринк", "Шорт дринк", "Шот"],["Горький","Кислый", "Сладкий"], ["На водке","На джине", "На роме","На текиле","На кальвадосе","На виски","На шампанском", "На ликерах"]];
